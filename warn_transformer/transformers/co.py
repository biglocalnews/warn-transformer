...
class Transformer(BaseTransformer):
    ...
    fields = dict(
        company = "company"
        location = lambda row: row["workforce_region"] or row["workforce_area"]
    ...
    date_corrections = {
        "N/A": None, 
        "": None, 
        "12/31/19 (for 265) Not specified for 191": datetime(2019, 31, 12), 
        ...
        "4/1/20-4/30/20 for hourly workers and May 2020 for salaried associates": datetime(2020, 4, 1), 
